...
# doppler.com/kubernetes-operator-bundle:$VERSION and doppler.com/kubernetes-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= doppler.com/kubernetes-operator
...
IMG ?= dopplerhq/kubernetes-operator:latest
...
dist: manifests kustomize
	...
	$(KUSTOMIZE) build config/default > deploy/recommended.yaml
